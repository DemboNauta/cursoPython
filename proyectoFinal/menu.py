...
def iniciar():
    while True:
        ...
        if opcion == '1':
            ...
            if cliente: print('Cliente  añadido correctamente')
        elif opcion == '4':
            ...
            if cliente:
                ...
                cliente_modificado=db.Clientes.modificar(dni, nombre, apellido)
                if cliente_modificado: print("Cliente modificado correctamente")
            else:
